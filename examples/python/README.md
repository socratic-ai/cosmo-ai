...
| `production_hooks.py` | Production hooks: redact PII before a tool call leaves the process, write a JSONL audit trail of every client-tool outcome, and refuse to wrap up a call whose outcome isn't documented. |
